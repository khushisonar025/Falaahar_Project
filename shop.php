...
<section class="category-buttons">
    ...
    <div class="buttons-container">
        <a href="shop.php?category=fruits" class="btn1 <?= $category === 'fruits' ? 'active' : ''; ?>">Fruits</a>
        <a href="shop.php?category=vegetables" class="btn1 <?= $category === 'vegetables' ? 'active' : ''; ?>">Vegetables</a>
        <a href="shop.php?category=localspecials" class="btn1 <?= $category === 'localspecials' ? 'active' : ''; ?>">Local Specials</a>
        <a href="shop.php?category=leafygreens" class="btn1 <?= $category === 'leafygreens' ? 'active' : ''; ?>">Leafy Greens</a>
        <a href="shop.php?category=seasonspecials" class="btn1 <?= $category === 'seasonspecials' ? 'active' : ''; ?>">Season's Specials</a>
        <a href="shop.php?category=herbs" class="btn1 <?= $category === 'herbs' ? 'active' : ''; ?>">Herbs & Seasoning</a>
    </div>
</section>
...
<section class="products">
    ...
    if ($category === 'fruits' || $category === 'vegetables' || $category === 'localspecials' 
    || $category === 'leafygreens' || $category === 'seasonspecials' || $category === 'herbs') {
